...
in with lib; {
  ...
  programs.waybar = {
    ...
    settings = [{
      ...
      "pulseaudio" = {
        format =
          "<span color='#f79902'>{icon}</span> {volume}% <span color='#FF4500'></span> {format_source}";
        format-bluetooth =
          "{volume}% <span color='#f79902'>{icon}</span> <span color='#FF4500'></span> {format_source}";
        format-bluetooth-muted =
          "<span color='#f79902'> {icon}</span> <span color='#FF4500'></span> {format_source}";
