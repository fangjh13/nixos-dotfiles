  ...
  balenaEtcher = with pkgs;
    appimageTools.wrapType2 (rec {
      ...
      src = fetchurl {
        ...
        url =
          "https://github.com/balena-io/etcher/releases/download/v${version}/balenaEtcher-${version}-x64.AppImage";
      };
      extraPkgs = pkgs: with pkgs; [ ];
    });
  icons = ./icon.png;
in {
  home.packages = with pkgs; [ balenaEtcher ];
